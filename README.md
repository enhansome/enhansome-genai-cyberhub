...
* 📚 [awesome-foundation-agents](https://github.com/FoundationAgents/awesome-foundation-agents) ⭐ 2,224 | 🐛 8 | 📅 2025-07-28 **\[Awesome List/GitHub]** - Curated list of foundation-model agent resources (general agent ecosystem context).
...
* 📊 [StealthBench](https://github.com/GangGreenTemperTatum/stealthbench) ⭐ 9 | 🐛 3 | 🌐 Python | 📅 2026-09-24 **\[Benchmark/GitHub]** - A benchmark for evaluating whether autonomous agents operate with operational security (OPSEC) discipline during security engagements.
